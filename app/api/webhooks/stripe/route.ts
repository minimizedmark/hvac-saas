...
export async function POST(req: Request) {
  ...
  if (event.type === 'checkout.session.completed') {
    ...
    await resend.emails.send({
      from: 'Mark - HVACflow <founding@hvacflow.app>',
      to: email,
      subject: `You're Founding Member #${slot}! 🚀`,
      html: `
        <h1>Congratulations – You're In!</h1>
        <p>You are officially Founding Member #${slot} of HVACflow.</p>
        <p>Locked pricing at $1,495/year – forever.</p>
        <p>Beta access coming 2 weeks before Phase 1 launch. Watch your email.</p>
        <p>Direct line to founder: (587) 402-8264</p>
